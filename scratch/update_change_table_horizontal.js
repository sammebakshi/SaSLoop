...
// Update isChangeTableModalOpen JSX design to be horizontal
...
const newModalStr = `{isChangeTableModalOpen && (
           <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100] p-4 backdrop-blur-sm">
              <div className={\`border rounded-[2rem] w-full max-w-2xl flex flex-col shadow-2xl overflow-hidden \${
                 ...
                 <div className="p-6 space-y-4">
                    ...
                    {/* Horizontal scroll of tables */}
                    <div className="flex flex-row gap-3 overflow-x-auto pb-4 pt-1 no-scrollbar scroll-smooth">
                       {tables
                         ...
                         .map(table => {
                            ...
                            return (
                               <button
                                  ...
                                  className={\`min-w-[125px] p-5 rounded-2xl border flex flex-col items-center justify-center gap-2 transition-all duration-200 active:scale-95 group cursor-pointer \${
                                     isOccupied
...
if (oldModalPattern.test(content)) {
  ...
  console.log("Modal JSX updated to horizontal layout successfully!");
} else {
