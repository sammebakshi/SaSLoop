    ...
    if (stepCount === 3990) {
        ...
        if (data.tool_calls) {
            for (let tc of data.tool_calls) {
                ...
                fs.writeFileSync('c:/Users/Sajad/Desktop/SaSLoop/scratch/chunks_3990.json', chunksStr, 'utf8');
                console.log("Successfully wrote chunks_3990.json! Size:", chunksStr.length);
            }
        }
    }
});
