...
edits.slice(1).forEach((editBlock, idx) => {
  ...
  if (cleanReplacement && !fileContent.includes(cleanReplacement) && fileContent.includes(cleanTarget)) {
    console.log(`\n=========================================`);
    console.log(`Edit #${editNum} MISSING: ${description}`);
    console.log(`File: ${absolutePath}`);
    console.log(`Target Content:`);
    console.log(cleanTarget);
    console.log(`-----------------------------------------`);
    console.log(`Replacement Content:`);
    console.log(cleanReplacement);
    console.log(`=========================================`);
  }
});
