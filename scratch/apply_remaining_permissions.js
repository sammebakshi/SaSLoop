...
// 2. useEffect for Auto-switch tab
replaceExactlyOnce(
`  useEffect(() => {
...
// 3. Sidebar navigation buttons wrapping (One-by-One)
replaceExactlyOnce(
...
// 14. Old KOT modal buttons in footer
replaceExactlyOnce(
...
// 16. Operations Management: Save Item
replaceExactlyOnce(
...
// 17. Operations Management: Delete Item
replaceExactlyOnce(
...
// 18. Operations Management: Toggle Item Availability
replaceExactlyOnce(
...
// 19. Operations Management: Toggle Category Active
replaceExactlyOnce(
...
// 21. Settings Tabs mapping filter
replaceExactlyOnce(
`                     {/* Tab Headers */}
