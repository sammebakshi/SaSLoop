...
const targetStr = `export const API_BASE = (
...
const replacementStr = `export const API_BASE = window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1"
    ? "http://localhost:5000"
    : 'https://backend.sasloop.in';`;
...
if (content.includes(targetStr)) {
  ...
  console.log("Success: Restored API_BASE back to production backend.");
} else {
