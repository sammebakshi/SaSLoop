...
const BillPrintReport = () => {
    ...
    const handlePrintThermalReport = () => {
        ...
        const printRows = data.map(b => `
            <div class="flex-between">
                <span class="bold">ORD#${b.order_id}</span>
                <span>bill #${b.bill_no}</span>
                <span class="bold">₹${parseFloat(b.amount || 0).toFixed(2)}</span>
            </div>
        `).join('');
        ...
        const printHtml = `
            ...
            <body>
                <div class="center bold" style="font-size: 14px;">BILL PRINT REPORT</div>
