    ...
    const handlePrintThermalReport = () => {
        ...
        const rows = data.map(j => `
            <div class="flex-between">
                <span class="bold">ORD#${j.order_id}</span>
                <span class="bold">${(j.status || 'SYNCED').toUpperCase()}</span>
            </div>
        `).join('');
        ...
        const printHtml = `
            <html>
            <head>
                <title>Jordan Regional Report</title>
                <style>
            ...
            <body>
                <div class="center bold" style="font-size: 14px;">JORDAN REGIONAL REPORT</div>
                ...
                <div class="flex-between bold">
                    <span>TOTAL REGIONAL EVENTS:</span>
